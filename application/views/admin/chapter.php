    <section class="content-header">
      <h1><?php echo $page_title; ?> <a class="btn btn-sm btn-default" href="admin/chapters/add">Add New</a></h1>
      <ol class="breadcrumb">
	...
	<script type="text/javascript">
		...
		var get_chapterslist = function (e) {
			var data = {
				visit_from : 'web',
			};
			$.ajax({
				url: "OAuth/chapterslist",
				type: "POST",
				dataType: "json",
				async: true,
				data: data,
